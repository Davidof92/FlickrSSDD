 ...
 * @author USUARIO100
 */
public class CrearAlbumDialog extends javax.swing.JDialog {

    /**
     * Creates new form CrearAlbumDialog
     */
    ...
    public String getNombreAlbum(){
        return nombreAlbum.getText();
    }
    
    public String getDescripcionAlbum(){
        return descripcionAlbum.getText();
    }
    
    public void setNombreAlbum(String nombre){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrearAlbumDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CrearAlbumDialog dialog = new CrearAlbumDialog(new javax.swing.JFrame(), true);
